...
(function(jQuery, ytp) {
                ...
                if (!YTPlayer.isBackground) {
                  if (YTPlayer.opt.backgroundUrl && YTPlayer.isPlayer) {
                    YTPlayer.opt.backgroundUrl =
                      YTPlayer.opt.backgroundUrl || YTPlayer.orig_background;
                    YTPlayer.opt.containment.css({
                      background:
                        'url(' + YTPlayer.opt.backgroundUrl + ') center center',
                      backgroundSize: 'cover',
                    });
                  }
                } else {
  ...
  jQuery.fn.optimizeDisplay = function(anchor) {
    ...
    YTPlayer.opt.anchor =
      typeof YTPlayer.opt.anchor != 'undefined '
        ? YTPlayer.opt.anchor
        : 'center,center';
