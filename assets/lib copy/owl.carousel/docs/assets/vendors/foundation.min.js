      ...
      events: function(d) {
        ...
        a('.scroll-container').length > 0 &&
          ...
          f(this.scope)
            ...
            .on('click.fndtn.clearing', this.settings.close_selectors, function(
              a
            ) {
    ...
    Foundation.libs.joyride = {
      ...
      show_modal: function() {
        if (!this.settings.$next_tip.data('closed')) {
          ...
          b.length < 1 &&
            a('body')
              .append(this.settings.template.modal)
              .show(),
            /pop/i.test(this.settings.tip_animation)
              ? b.show()
          ...
          if (e.deep_linking) {
            ...
            if ('' != f) {
              ...
              if (g.hasClass('content') && g.parent().hasClass('tab-content'))
                b.toggle_active_tab(
                  a('[' + b.attr_name() + '] > dd > a[href=' + f + ']').parent()
                );
              else {
        ...
        if (
          (f(this).data(this.data_attr('tab-content')) &&
            ((i =
              '#' +
              f(this)
                .data(this.data_attr('tab-content'))
                .split('#')[1]),
            (j = f(i))),
          l.deep_linking)
        ) {
